...
const translations = {
    ko: {
        ...
        sol_expected_title: "도입 기대 효과",
        sol_effect_label: "핵심 성과",
        sol1_effect: "생산성 25% 향상 및 불량률 18% 감소",
        sol2_effect: "작업 정밀도 200% 개선 및 24시간 가동",
        sol3_effect: "적재 효율 30% 증대 및 인건비 45% 절감",
        sol4_effect: "오차율 0% 목표 및 안전한 시약 취급",
        sol1_full: "자동차 산업에서는 정밀함과 속도가 핵심입니다. AI-ROBO는 고도화된 비전 알고리즘을 통해 차체 조립, 볼트 체결, 실링 도포 공정을 완벽하게 수행합니다. 초보자도 쉽게 티칭할 수 있는 UI를 통해 공정 변경 시 즉각적인 대응이 가능합니다.",
        sol2_full: "전자 및 반도체 공정은 미세한 정전기(ESD)에도 치명적일 수 있습니다. AI-ROBO는 특수 정전기 방지 설계와 0.03mm의 초정밀 반복 정밀도를 바탕으로 PCB 조립 및 부품 검사에서 최고의 성능을 발휘합니다.",
        sol3_full: "스마트 물류 환경에서 AI-ROBO는 딥러닝 기반의 객체 인식 기술을 사용하여 다양한 크기와 무게의 박스를 실시간으로 판별합니다. 최적화된 적재 경로(Path Planning)를 계산하여 물류 효율을 최대화합니다.",
        sol4_full: "의료 및 실험실 환경은 청결과 정확성이 생명입니다. AI-ROBO는 멸균 환경을 지원하며, 액체 샘플링 및 피펫팅 작업 등 고도로 반복적이고 섬세한 작업을 실시간 모니터링하며 안전하게 수행합니다.",
...
✔ 커넥터 레버 잠금 상태 및 주변 구조물 간섭 여부`,
    ...
    en: {
        ...
        sol_expected_title: "Anticipated ROI",
        sol_effect_label: "Key Performance",
        sol1_effect: "25% productivity boost & 18% defect reduction",
        sol2_effect: "200% precision improvement & 24/7 operation",
        sol3_effect: "30% more space efficiency & 45% labor savings",
        sol4_effect: "Zero-error goal & safe chemical handling",
        sol1_full: "Precision and speed are paramount in the automotive industry. AI-ROBO utilizes advanced vision algorithms to perfectly execute chassis assembly, bolt tightening, and sealing processes. Its intuitive UI allows even beginners to adapt quickly to process changes.",
        sol2_full: "Electronics and semiconductor processes are vulnerable to even minor electrostatic discharge (ESD). AI-ROBO, with its specialized ESD protection and 0.03mm precision, delivers peak performance in PCB assembly and component inspection.",
        sol3_full: "In smart logistics, AI-ROBO uses deep learning-based object recognition to identify boxes of various sizes and weights in real-time. It maximizes efficiency by calculating optimized path planning for palletizing.",
        sol4_full: "Health and lab environments require extreme cleanliness and accuracy. AI-ROBO supports sterile environments and safely performs highly repetitive, delicate tasks like liquid sampling and pipetting with real-time monitoring.",
